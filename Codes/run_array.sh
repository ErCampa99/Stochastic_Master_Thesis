...
#SBATCH --job-name=EasyRunZ2
#SBATCH --output=logs/out_%A_%a.log    # %A = job ID, %a = array index
...
#SBATCH --time=2:00:00
#SBATCH --mem=96G
#SBATCH --array=0-1                    # 2 phi-pairs: task 0 e task 1
